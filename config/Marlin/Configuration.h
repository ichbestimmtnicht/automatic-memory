...
#define STRING_SPLASH_LINE2 "Assembled and configured from ichbestimmtnicht"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Zauberkasten"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "b025c4ae-ddf6-4d30-84a7-ef484920cd2d"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.94, 80.51, 2560, 94.66 }
...
#define MAX_SOFTWARE_ENDSTOPS
  ...
  #define MAX_SOFTWARE_ENDSTOP_X 195
  #define MAX_SOFTWARE_ENDSTOP_Y 195
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define FRONT_PROBE_BED_POSITION 147
...
//  #define MESH_EDIT_GFX_OVERLAY   // Display a graphics overlay while editing the mesh
  ...
  #define UBL_PROBE_PT_1_X 100       // Probing points for 3-Point leveling of the mesh
  #define UBL_PROBE_PT_1_Y 100
